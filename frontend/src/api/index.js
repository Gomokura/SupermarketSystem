...
export const orderAPI = {
  ...
  getTimeline: (orderId) => request.get(`/orders/${orderId}/timeline`),
  adminGetTimeline: (orderId) => adminRequest.get(`/orders/admin/${orderId}/timeline`),
...
export const uploadAPI = {
  uploadImage: (file) => {
    ...
    return adminRequest.post('/admin/upload/image', formData, {
...
export const brandAPI = {
  ...
  adminGetList: (params) => adminRequest.get('/brands/list', { params }),
...
export const adminAPI = {
  ...
  updateAdminStatus: (id, status) => adminRequest.put(`/admin/admins/${id}`, { status }),
  ...
  getActivePromotions: () => adminRequest.get('/promotions/active'),
...
export const purchaseAPI = {
  list: (params) => adminRequest.get('/purchase/list', { params }),
  create: (data) => adminRequest.post('/purchase/create', data),
  detail: (poId) => adminRequest.get(`/purchase/${poId}`),
  approve: (poId) => adminRequest.put(`/purchase/${poId}/approve`),
  receive: (poId, items) => adminRequest.put(`/purchase/${poId}/receive`, { items }),
  cancel: (poId) => adminRequest.put(`/purchase/${poId}/cancel`)
}