...
/** CartAddServlet - 加入购物车 */
public class CartAddServlet extends BaseServlet {
    public void doAction(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Integer quantity = getInteger(req, "quantity", 1);
        Integer skuId = getInteger(req, "skuId");
        CartService cartService = new CartService();
        Result<?> result = cartService.addToCart(userId, productId, quantity, skuId);
